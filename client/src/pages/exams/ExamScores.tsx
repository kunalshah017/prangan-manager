...
export default function ExamScores() {
  const { projectId, centerId, semesterId, examId } = useParams(); const { user } = useAuth(); const navigate = useNavigate();
